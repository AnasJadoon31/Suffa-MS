...
registry.register(
    ...
    Permission("timetable.manage", "Build timetables", "timetable", scoped=False),
    Permission("holidays.manage", "Manage the holiday calendar", "holidays", scoped=False),
    Permission("leave.manage", "Approve/decline leave requests", "leave", scoped=False),
    Permission("admissions.manage", "Review admission applications & registrations", "admissions", scoped=False),
    Permission("settings.manage", "Edit madrasa settings", "settings", scoped=False),
    Permission("resources.manage", "Manage the resource library (own sections/categories)", "resources", scoped=True),
    Permission("resources.manage_all", "Manage/override any teacher's resources & categories", "resources", scoped=False),
    Permission("forms.create", "Build forms", "forms", scoped=True),
    Permission("forms.manage_all", "Manage/override any teacher's forms", "forms", scoped=False),
