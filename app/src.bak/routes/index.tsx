    ...
    <div className="gradient-emerald flex min-h-screen flex-col text-primary-foreground">
      <div className="pt-safe px-6 pb-10 pt-16">
        <div className="mx-auto max-w-lg">
          ...
          <h1 className="mt-6 font-display text-3xl font-extrabold leading-tight">Suffa MS</h1>
          <p className="mt-2 max-w-xs text-sm text-primary-foreground/75">
            Attendance, people and academics — designed for the phone in your pocket.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 rounded-t-[2rem] bg-background px-6 pb-10 pt-8 text-foreground">
        <form onSubmit={onSubmit} className="mx-auto max-w-lg space-y-4">
          <Field icon={<Building2 className="h-4 w-4" />} label="Madrasa">
            <input
          ...
          <Field icon={<UserRound className="h-4 w-4" />} label="Username">
            <input
              className="w-full bg-transparent text-base outline-none placeholder:text-muted-foreground"
              value={username}
          ...
          <p className="pt-2 text-center text-xs text-muted-foreground">
            Trouble signing in? Contact your madrasa administrator.
          </p>
        </form>
      </div>
    </div>
