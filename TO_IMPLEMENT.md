...
| ISS3-029 | P0 | Guardian portal navigation and dashboard expose applicable Announcements and Forms, including class/section/ward-targeted content. With multiple children, the selected child scopes the content and the UI identifies which child each item concerns. | API guardian-scope tests; E2E one- and multi-child journeys; dashboard/forms/announcements screenshots. | WIP |
